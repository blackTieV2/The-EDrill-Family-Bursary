# The EDrill Family Bursary - Evidence Checklist
...
## 2. Applicant Eligibility Evidence

| Evidence item | Required | Received | Verified by | Notes |
| --- | --- | --- | --- | --- |
| Applicant identity / employee record | Yes |  | HR |  |
| Employer confirmed | Yes |  | HR / Operations |  |
| Worksite / rig / Thailand operations scope confirmed | Yes |  | HR / Operations |  |
| Minimum service confirmed | Yes |  | HR |  |
| Salary threshold confirmed | Yes |  | HR / Finance | Use threshold confirmation where possible, not detailed payroll |
| No duplicate education benefit declared | Yes |  | HR / Finance |  |

## 3. Labour-Hire Agency Evidence, If Applicable

| Evidence item | Required | Received | Verified by | Notes |
| --- | --- | --- | --- | --- |
| Labour-hire agency employment verified | If applicable |  | labour-hire agency / Operations |  |
| Assignment to EDrill rig verified | If applicable |  | Operations |  |
| Continuous work since 1 Jan 2025 verified | If applicable |  | Operations / labour-hire agency |  |
| labour-hire agency acknowledgement obtained | If required |  | Legal / Operations |  |

## 4. Child Eligibility Evidence
...
| Evidence item | Required | Received | Verified by | Notes |
| --- | --- | --- | --- | --- |
| School invoice / fee note | Yes |  | HR / Finance |  |
| Receipt / proof of payment | For reimbursement |  | Finance |  |
...
| Evidence item | Required | Received | Verified by | Notes |
| --- | --- | --- | --- | --- |
| Applicant declaration signed | Yes |  | HR |  |
| Privacy notice issued | Yes |  | HR |  |
| Consent for verification obtained | Yes |  | HR |  |
| Specific publicity consent | Only if publicity proposed |  | HR / Legal | Not part of normal application consent |

## 8. Checklist Outcome

| Outcome | Tick / notes |
| --- | --- |
| Complete and ready for eligibility screening |  |

# The EDrill Family Bursary - Decision Log

Working status: live decision register  
Purpose: capture approved decisions, unresolved questions, assumptions, and evidence before formal documents are drafted or issued.  
Rule: no item should be treated as approved unless the decision, owner, date, and evidence/source are recorded.

## 1. Decision Status Key

Use the following status labels consistently:

- Approved: decision confirmed by accountable owner.
- Provisional: working assumption allowed for drafting, but not for launch.
- Open: decision not yet made.
- Blocked: decision cannot be made until another action is completed.
- Superseded: earlier decision replaced by a later approved decision.
...
- Labour-hire agency payment route: EDPL pays the appointed labour-hire agency at the time of application for onward payment to its employee using the agency's existing payroll/payment process.
...
| EX-03 | Legal/funding entity | Energy Drilling Pte. Ltd. (EDPL) | Approved | Finance / Executive Sponsor / Committee | EDPL is the confirmed Phase 1 funding entity. Cost centre / GL code is a Finance administrative processing detail and is not a policy blocker. | Management decision 2026-06-11 | 2026-06-11 |
...
| ID | Decision area | Current recommended position | Status | Accountable owner | Decision / final wording | Evidence/source | Date |
| --- | --- | --- | --- | --- | --- | --- | --- |
| EL-01 | Eligible EDrill employees | Thailand operations employees / crew assigned to ED1, ED2, T15, T16, GHTH, and EVE, subject to criteria | Provisional | Bangkok HR / Operations |  | Email chain |  |
| EL-02 | Salary threshold | Monthly salary below THB 100,000 | Provisional | HR / Finance |  | Email chain |  |
| EL-03 | Salary definition | Gross fixed monthly salary, excluding variable components, allowances, bonuses, overtime, offshore payments, discretionary payments, and other non-fixed amounts, unless otherwise approved by Finance and the Committee | Approved | Finance / HR / Committee | Finance/proxy review confirmed salary definition | Finance/proxy review comments | 2026-06-15 |
| EL-04 | Salary test date | Application closing date and award approval date | Provisional | HR / Finance |  | Decision questionnaire default |  |
| EL-05 | Minimum service / assignment | Continuous service or assignment connected with EDrill Thailand operations from 1 January 2025, with no break exceeding 30 days, unless an exception is approved by the Committee | Approved | HR / Executive Sponsor / Committee | Finance/proxy review confirmed service and assignment rule | Finance/proxy review comments | 2026-06-15 |
| EL-06 | Child age | An eligible child must be 12 years old or younger throughout the relevant Award Year. | Approved | HR / Executive Sponsor | Age eligibility wording simplified with no substantive change to the approved age limit | User clarification 2026-06-11; wording clarification 2026-06-15 | 2026-06-15 |
| EL-07 | Child relationship | Include child, adopted child, stepchild, legal dependant, or child under legal guardianship if documented | Provisional | HR / Legal |  | Decision questionnaire default |  |
| EL-08 | Multiple children per family | A family may apply for multiple eligible children. Each child/application is means-tested and assessed separately under the approved criteria and the annual award cap. | Provisional | HR / Executive Sponsor | User confirmed one family can apply for multiple children and all are means-tested | User clarification 2026-06-11 | 2026-06-11 |
| EL-09 | Other education benefits | No double benefit for same child and same expense | Provisional | HR / Finance |  | Decision questionnaire default |  |

## 5. Schooling Decisions

| ID | Decision area | Current recommended position | Status | Accountable owner | Decision / final wording | Evidence/source | Date |
| --- | --- | --- | --- | --- | --- | --- | --- |
| SC-01 | School country | Thailand only | Provisional | Executive Sponsor / HR |  | Email chain |  |
| SC-02 | Government schools | Included | Provisional | Executive Sponsor / HR |  | Email chain |  |
| SC-03 | Private schools | Included | Provisional | Executive Sponsor / HR |  | Email chain |  |
| SC-04 | International schools | Applicant must list the school attended; government and private schools in Thailand are included, and committee/Finance should assess cost reasonableness rather than exclude solely by label unless the Executive Sponsor approves an exclusion, cap, or separate rule | Provisional | Executive Sponsor / HR / Finance | User said school attended should be part of the application | User clarification 2026-06-11 | 2026-06-11 |
| SC-05 | Special education schools | Included if located in Thailand and properly evidenced | Provisional | HR / Legal |  | Decision questionnaire default |  |
| SC-06 | Homeschooling / online schooling | Excluded for first launch unless legally recognised and evidence is clear | Provisional | HR / Legal |  | Decision questionnaire default |  |
| SC-07 | School evidence | Birth certificate or approved equivalent, plus school enrolment letter or confirmation; Finance verifies salary eligibility internally | Provisional | HR / Finance | User confirmed birth certificate and school enrolment letter; Finance already knows payslip/salary | User clarification 2026-06-11 | 2026-06-11 |

## 6. Award Value and Payment Decisions

| ID | Decision area | Current recommended position | Status | Accountable owner | Decision / final wording | Evidence/source | Date |
| --- | --- | --- | --- | --- | --- | --- | --- |
| PAY-01 | EDrill award value | Up to THB 120,000 per awardee per year | Provisional | Executive Sponsor / Finance |  | Email chain |  |
...
| PAY-11 | Carry-forward | No carry-forward of unused award funds | Provisional | Finance / HR |  | Decision questionnaire default |  |

## 7. Selection and Governance Decisions

| ID | Decision area | Current recommended position | Status | Accountable owner | Decision / final wording | Evidence/source | Date |
| --- | --- | --- | --- | --- | --- | --- | --- |
| GOV-01 | Selection method | No further Marcus clarification is outstanding. If eligible applications exceed available bursary places, the Committee applies a means-tested, need-weighted assessment considering financial need and family circumstances. | Provisional | HR / Executive Sponsor | User confirmed no questions for Marcus and to move on | User clarification 2026-06-11 | 2026-06-11 |
...
| GOV-07 | Committee membership | Alex Maroske - Chairman; Jacquline Ho - Financial Controller, Singapore; Malee Pasutharnchart - Office Manager / Finance, Thailand; Luke Byrne - Director of Operations, Thailand; Sittikorn Intahkaew - Regional QHSSE Manager | Approved | Executive Sponsor / HR / Committee | Phase 1 Bursary Committee membership confirmed | Management decision 2026-06-11 | 2026-06-11 |
...
| GOV-11 | Mid-year eligibility changes | If employment, assignment, schooling, eligibility, or other relevant circumstances change during an Award Year, the Committee may continue, suspend, cease, or prorate the award on a case-by-case basis, considering the circumstances and the needs of the family | Approved | Committee / HR / Finance | Finance/proxy review confirmed case-by-case mid-year change treatment | Finance/proxy review comments | 2026-06-15 |

## 8. Labour-Hire Agency Decisions
...
| KO-02 | Continuous service / assignment requirement | Continuous service or assignment connected with EDrill Thailand operations from 1 January 2025, with no break exceeding 30 days, unless an exception is approved by the Committee | Approved | Operations / labour-hire agency / Committee | Finance/proxy review confirmed service and assignment rule | Finance/proxy review comments | 2026-06-15 |
...
| --- | --- | --- | --- | --- |
| Funding entity confirmed | Closed | Finance / Executive Sponsor / Committee | EDPL confirmed as Phase 1 funding entity | 2026-06-11 |
...
Use this section when drafting formal documents before all decisions are closed.
...
| 2026-06-11 | Phase 1 blocker decisions incorporated | ChatGPT | Closed or reclassified committee appointment, EDPL funding entity, payroll/payment mechanics, internal compliance approval, and labour-hire agency payment model; final communications approval remains open |

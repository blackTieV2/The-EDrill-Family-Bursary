# The EDrill Family Bursary - Decision Questionnaire

Working status: pre-drafting decision pack  
...
The long-term option of a Singapore Registry of Societies model should remain in scope, but it should not control the first launch. The first launch should create good governance records so that a future ROS or employee/member-funded structure can be developed later if required.

### Decisions Needed From Marcus / Executive Sponsor

| No. | Decision | Recommended default | Decision / comment |
| --- | --- | --- | --- |
| 1 | Confirm scheme name | The EDrill Family Bursary |  |
| 2 | Confirm scheme owner / funding entity | Energy Drilling Management Pte. Ltd. acting through its Thailand registered presence / Thailand office, subject to Finance confirmation |  |
| 3 | Confirm launch date | 1 October 2026 |  |
| 4 | Confirm first-year scope | Thailand only |  |
| 5 | Confirm whether Myanmar is excluded for launch | Excluded for launch; may be reviewed later |  |
...
| --- | --- | --- | --- |
| 13 | Must the employee be Thai, Thailand-based, or assigned to Thailand operations? | Assigned to Thailand operations and locally administered by Bangkok HR |  |
...
| No. | Question | Recommended default | Decision / comment |
| --- | --- | --- | --- |
| 26 | Should payment be made to school, employee, or by reimbursement? | Current instruction: EDrill employee awards paid directly to employee bank account; labour-hire awards paid to the relevant agency for onward payment to employee |  |
| 27 | If paid to employee, should it go through payroll? | To be decided by Finance/Payroll based on Thai tax treatment |  |
| 28 | What expenses are eligible? | Tuition, compulsory school fees, books, uniforms, and required school materials |  |
| 29 | Are transport, meals, devices, or tutoring included? | Recommended: excluded unless expressly approved |  |
| 30 | What if actual school costs are lower than the bursary value? | Pay or reimburse only evidenced eligible costs up to the award limit |  |
| 31 | Can unused award funds be carried forward? | Recommended: no |  |

### Selection

| No. | Question | Recommended default | Decision / comment |
| --- | --- | --- | --- |
| 32 | If more than six applications are eligible, how are awardees selected? | Committee scoring against published criteria |  |
| 33 | Should the scheme use academic merit? | Recommended: no, except minimum proof of enrolment/attendance; this is a welfare bursary, not a prize |  |
| 34 | Should renewal applicants be assessed with new applicants? | Yes. Yearly reset; applications for the next award year due to the Committee by 1 October of the previous year |  |
| 35 | Should applications be anonymised for committee review? | Yes. Finance first confirms salary-cap eligibility, then applications are anonymised for Committee review |  |
| 36 | Is there an appeal process? | Recommended: yes, limited to procedural error, new evidence, or exceptional hardship |  |

## 3. Labour-Hire Agency Decisions

This is the most sensitive part of the scheme. The practical aim is clear, but the legal wording must avoid implying that labour-hire agency employees are EDrill employees.

| No. | Question | Recommended default | Decision / comment |
| --- | --- | --- | --- |
| 37 | Who verifies labour-hire agency employment status? | Relevant labour-hire agency, confirmed by EDrill Operations |  |
...
These questions should be answered before any award letter is issued.
...
| 49 | What withholding, reporting, or payslip treatment is required? |  |
| 50 | What documentation is required for deductibility or audit support? |  |
| 51 | How should labour-hire-agency-related awards be booked? |  |
| 52 | Does the scheme create any anti-bribery, vendor, or related-party concern? |  |
| 53 | Is Board, executive, or shareholder approval required for this expenditure? |  |

## 5. Legal / Compliance / Privacy Questions

These questions are intended to prevent a good-hearted scheme from creating avoidable legal exposure.

| No. | Question | Answer / comment |
| --- | --- | --- |
| 54 | Does Thai labour law treat this as a welfare benefit, discretionary benefit, or contractual entitlement? |  |
| 55 | What wording is required to preserve discretion and avoid automatic entitlement? |  |
| 56 | What child data and family data can HR collect? |  |
| 57 | What privacy consent wording is required? |  |
| 58 | Can school records be verified directly with schools? |  |
| 59 | Are there restrictions on transferring applicant data to Singapore management? |  |
| 60 | Does including labour-hire agency employees create deemed-employer, co-employment, fair-benefits, or contractor-management risk? |  |
| 61 | Is a formal agreement or acknowledgement required from each participating labour-hire agency? |  |
| 62 | Are there any restrictions on publicising the scheme or beneficiaries? |  |
| 63 | If the scheme later accepts employee/member contributions in Singapore, what registration, charity, or fundraising steps are likely to be required? |  |

## 6. Recommended First-Year Operating Model

The following model is recommended unless the decision-makers choose otherwise:

- Scheme type: internal company-funded discretionary education bursary.
- Launch geography: Thailand only.
- Administration: Bangkok HR, with Finance and Operations support.
- Governance: small committee with HR, Finance, Operations, and senior sponsor approval.
- Award volume: up to six awards per award year.
- EDrill employee award: up to THB 120,000 per year per awardee.
...
This scoring model is only a draft. It should be reviewed by HR and approved before use.
...
## 8. Documents To Draft After Decisions Are Returned

Once the questionnaire has been answered, the following can be drafted:

1. Bursary Charter
2. Bursary Procedure / SOP
3. Eligibility and Selection Rules
4. Application Form
5. Applicant Declaration and Consent Form
6. Required Evidence Checklist
7. Committee Review Sheet
8. Award Letter
9. Unsuccessful Application Letter
10. Renewal Review Form
11. Appeals / Exception Request Form
12. Annual Scheme Report Template
13. Internal Launch Message
14. LinkedIn Post
15. Future Singapore ROS / Fundraising Conversion Note

## 9. Short Email To Send With This Questionnaire

Subject: EDrill Family Bursary - decisions required before drafting documents

Dear all,

Following the initial discussion on the EDrill Family Bursary for Thailand operations, I have prepared the attached decision questionnaire to confirm the key points before the formal charter, procedure, forms, and communication materials are drafted.

The main recommendation is to treat the first launch as an internal company-funded education bursary administered by the Bangkok office, rather than as a separate charity, foundation, or registered society. This keeps the first implementation practical while preserving the option to develop a more formal Singapore ROS or employee/member-funded structure later if the scheme grows.

The most important items to confirm are the funding entity, Thai tax/payroll treatment, labour-hire agency handling, selection method if applications exceed six places, and approval timing for LinkedIn/corporate website communication.

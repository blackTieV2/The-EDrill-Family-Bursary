...
This Charter records the approved governance, scope and operating principles for Phase 1 of The EDrill Family Bursary. Phase 1 application intake and award administration remain subject to completion of the Launch Approval Checklist and any required launch evidence controls.

## 1. Purpose

The EDrill Family Bursary is intended to provide education support for eligible children of eligible employees connected with Energy Drilling's Thailand operations.

The Bursary recognises that access to schooling is an important part of family welfare and that EDrill's operational success depends on the contribution of employees and workers supporting its rigs and operations.

## 2. Nature of the Bursary

The Bursary is an internal, company-funded, discretionary education support scheme.

It is not intended to create:

- a contractual employment entitlement;
...
The Company may amend, suspend, replace, or discontinue the Bursary at any time, subject to applicable law and internal approval requirements.

## 3. Scope

The first implementation of the Bursary applies to Thailand operations only.

The Bursary may be reviewed in future to consider whether it should be extended to other locations, including Myanmar, but no such extension applies unless formally approved.

## 4. Definitions

For this Charter:

- "Award Year" means the annual period for which a Bursary is granted. The first Award Year commences on 1 October 2026, subject to completion of the Launch Approval Checklist.
...
- verification of labour-hire agency employment;
- verification of continuous service or assignment;
- payment route;
- standard eligibility wording;
- data handling;
- acknowledgement by the relevant labour-hire agency, if required.
...
Costs such as transport, meals, devices, tutoring, extracurricular activities, or other expenses are excluded unless expressly approved in the Bursary rules.

If actual eligible costs are lower than the maximum Bursary value, the Company may limit payment or reimbursement to the evidenced eligible costs.

Unused award amounts do not carry forward unless expressly approved.
...
1. administering the application cycle;
2. screening eligibility;
3. reviewing evidence;
4. applying the approved selection method;
5. recording decisions;
6. managing conflicts of interest;
7. recommending awards for approval;
8. reviewing renewals;
9. preparing an annual report.

Finance cannot be the sole decision-maker for awards. HR cannot approve payments without Finance control. Any committee member with an actual, potential, or perceived conflict of interest must declare it and recuse themselves from the relevant decision.
...
The Committee applies a means-tested, need-weighted assessment considering financial need, family circumstances, service/continuity, school cost burden, and completeness of evidence.
...
The Bursary involves personal data relating to employees, children, family circumstances, salary, schooling, and financial evidence.
...
Beneficiary names, photographs, or personal stories must not be published unless specific written consent is obtained.
...
Appeals should not be used to challenge the existence of limited Bursary places or to create an entitlement where eligibility is not met.

Any exception must be approved by the appropriate authority and recorded with reasons.

## 16. Annual Review

The Committee should prepare an annual review report after each Award Year.
...
- whether future expansion or structural change should be considered.

The annual review should also consider whether the Bursary should remain an internal company-funded scheme or whether a different structure should be considered.
...
If employee/member contributions, public appeals, or a separate Singapore-based body are later considered, the Company must review applicable Singapore Registry of Societies, charity, fundraising, tax, accounting, and governance requirements before accepting contributions or making public appeals.

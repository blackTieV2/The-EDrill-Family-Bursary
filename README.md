...
Phase 1 uses a Chairman/Committee-approved internal compliance position; no external legal advice obtained. The Bursary Charter is approved for controlled issue as version 1.0, effective 1 October 2026, at `01_drafting/policy/approved/EDrill_Family_Bursary_Charter.md`. Remaining documents remain in draft folders unless separately promoted, and operational launch remains subject to the Launch Approval Checklist, Launch Evidence Register, and final communications checks.

## Current Status After b9b5aa1

Phase 1 policy decisions are now resolved.

The Charter has been approved for controlled issue. Remaining documents remain draft until separate final issue approval is recorded. The next gate is launch evidence setup and remaining document/control approvals.

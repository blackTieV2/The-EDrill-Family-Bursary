# The EDrill Family Bursary - 2026-2027 Launch Evidence Register

Status: Open / pending evidence
Purpose: operational evidence checklist for the first Phase 1 Award Year.

This register records launch administration evidence only. It does not by itself launch the Bursary, open applications, approve awards, or authorise publication.
...
| No. | Evidence item | Status | Evidence location / link | Owner | Date received | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | Final approved policy/charter | Open / pending evidence |  |  |  |  |
| 2 | Final approved SOP | Open / pending evidence |  |  |  |  |
| 3 | Final approved eligibility criteria | Open / pending evidence |  |  |  |  |
...
| 7 | Conflict/confidentiality declarations completed | Open / pending evidence |  |  |  |  |
| 8 | Finance/payroll instruction process confirmed | Open / pending evidence |  |  |  |  |
| 9 | Payroll line item method confirmed | Open / pending evidence |  |  |  |  |
| 10 | Labour-hire agency acknowledgement received, if applicable | Open / pending evidence |  |  |  |  |
...
| Question | Response |
| --- | --- |
| Are all required evidence items complete? |  |
| Are any items not applicable? |  |
| Are any conditions outstanding? |  |
| Is the Launch Approval Checklist complete? |  |
| Is the Bursary ready to open applications? |  |
